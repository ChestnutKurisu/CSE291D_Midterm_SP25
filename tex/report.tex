...
\usepackage[dvipsnames,svgnames,x11names]{xcolor} % full colour set + blends (blue!70!black etc.)
\definecolor{linkblue}{HTML}{1A4B9B}   % optional: explicit named colours
\definecolor{citepink}{HTML}{AA0066}
\definecolor{urlteal}{HTML}{006D6D}

\hypersetup{
  colorlinks = true,
  linkcolor  = linkblue,     % or blue!70!black
  citecolor  = citepink,     % or magenta!80!black
  urlcolor   = urlteal       % or teal!80!black
}
